    ...
    $.fn.condense = function(options) {
        ...
        return this.each(function() {
            ...
            if (clone){
                ...
                var controlMore = " <span class='condense_control condense_control_more' style='cursor:pointer; border-bottom: 2px solid #000;'>"+o.moreText+"</span>";
                if (o.inline) {
                ...
                $par.append(clone);
                if(o.lessText) {
                    var controlLess = " <span class='condense_control condense_control_less' style='cursor:pointer; border-bottom: 2px solid #000;'>"+o.lessText+"</span>";
